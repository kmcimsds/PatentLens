...
export const DUMMY_PATENT: PatentAnalysis = {
  ...
  priorArt: [
    {
      reference: "US8765432B2",
      approach:
        "황산 등 균일계 산 촉매를 사용해 셀룰로오스 가수분해물을 180 °C 이상에서 직접 탈수하는 공정을 제시함.",
      limitation:
        "고온 조건에서 휴민(humin) 부생성물이 다량 생성되어 5-HMF 선택도가 40% 수준에 머물고, 산 촉매 회수와 설비 부식 문제가 남음.",
    },
    {
      reference: "WO2015/098765A1",
      approach:
        "Ru 단일 금속을 활성탄에 담지한 촉매로 당류를 수소화하여 폴리올을 제조하는 방법을 개시함.",
      limitation:
        "단일 금속 촉매라 반응 선택도 조절이 어렵고, 반복 사용 시 금속 용출로 5회 재사용 후 활성이 절반 이하로 감소함.",
    },
    {
      reference: "선행 기술 1",
      approach:
        "이온성 액체를 반응 매질로 사용해 낮은 온도에서 당 전환을 유도하는 접근이 배경기술에 언급됨.",
      limitation:
        "이온성 액체 단가가 높고 생성물 분리·용매 재생 비용이 커서 상용 규모 공정으로 확장하기 어려움.",
    },
  ],
  methods: [
    {
